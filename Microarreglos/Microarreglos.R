...
library(Biobase) ## Cargar librería 
library(limma) ## Cargar librería 
...
types <- factor (c ("KO", "KO", "KO", "WT", "WT", "WT")) ## Dar la categoría de factor a al vector de...cepas u objetos de estudio
...
library (mouse4302.db) ## Cargar la libería (anteriormente instalada)
